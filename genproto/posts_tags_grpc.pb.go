...
type PostTagServiceClient interface {
	...
	CreatePostTag(ctx context.Context, in *PostTagCreate, opts ...grpc.CallOption) (*PostTag, error)
...
func (c *postTagServiceClient) CreatePostTag(ctx context.Context, in *PostTagCreate, opts ...grpc.CallOption) (*PostTag, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PostTag)
...
type PostTagServiceServer interface {
	...
	CreatePostTag(context.Context, *PostTagCreate) (*PostTag, error)
...
func (UnimplementedPostTagServiceServer) CreatePostTag(context.Context, *PostTagCreate) (*PostTag, error) {
...
func _PostTagService_CreatePostTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostTagServiceServer).CreatePostTag(ctx, req.(*PostTagCreate))
	}
	return interceptor(ctx, in, info, handler)
}
